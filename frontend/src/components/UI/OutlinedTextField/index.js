...
const useStyles = makeStyles(theme => ({
  textField: props => ({
    ...
    '& input': {
      ...
      color: theme.palette.secondary.contrastText, //'rgb(40,40,40)'
      '-webkit-text-fill-color': props.readOnly ? `${theme.palette.secondary.contrastText}80` : theme.palette.secondary.contrastText, //'rgb(40,40,40)',//
      ...
      '&:focus': {
        color: theme.palette.primary.contrastText, //'rgb(0,0,0)',//
    ...
    '& textarea': {
      color: theme.palette.secondary.contrastText, //'rgb(40,40,40)',//
      '&:focus': {
        color: theme.palette.primary.contrastText //'rgb(40,40,40)'//
      },
      '&::placeholder': {
        color: theme.palette.secondary.contrastText, //'rgb(40,40,40)'//
      }
